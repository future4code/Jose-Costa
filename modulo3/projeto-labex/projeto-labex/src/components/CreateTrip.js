import { Pane, SideSheet, Card, Heading, Button, TextInputField, SelectField, toaster } from "evergreen-ui"
    ...
    return (
        <React.Fragment>
            <SideSheet isShown={props.criarViagem} onCloseComplete={() => props.abrirCriar(false, "")} containerProps={{ display: 'flex', flex: '1', flexDirection: 'column' }} >
                ...
                <Pane flex="1" overflowY="scroll" backgroundColor="#DCF2EA" padding={16}>
