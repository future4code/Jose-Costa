...
export const getTask = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const resultResponsible = await connection("TasksAndResponsible").select("TasksAndResponsible.user_id", "Users.nickname").whereLike("task_id", task_id).join("Users", "Users.user_id", "=", "TasksAndResponsible.user_id");
